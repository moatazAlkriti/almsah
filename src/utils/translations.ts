...
export const translations = {
  ar: {
    ...
    exportDxf: 'AutoCAD كاد (.dxf)',
    exportCivil3dCsv: 'Civil 3D (PNEZD CSV)',
    dxfTextHeight: 'مقياس حجم النصوص (متر)',
    dxfIncludeElevation: 'تضمين المناسيب (Elevation)',
    dxfIncludePointNames: 'تضمين أرقام وأسماء النقاط',
    dxfIncludeDescriptions: 'تضمين الأوصاف والتصنيفات',
    dxfIncludeLines: 'تضمين الخطوط والمسارات',
    dxfLayersInfo: 'طبقات الأوتوكاد المفصولة (Layers)',
  ...
  en: {
    ...
    exportDxf: 'AutoCAD Drawing (.dxf)',
    exportCivil3dCsv: 'Civil 3D (PNEZD CSV)',
    dxfTextHeight: 'Text Height Scale (m)',
    dxfIncludeElevation: 'Include Elevations (Z-levels)',
    dxfIncludePointNames: 'Include Point Names & IDs',
    dxfIncludeDescriptions: 'Include Descriptions & Codes',
    dxfIncludeLines: 'Include Lines & Polylines',
    dxfLayersInfo: 'Organized CAD Layers',
